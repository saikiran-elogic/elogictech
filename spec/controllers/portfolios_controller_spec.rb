  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved portfolio as @portfolio" do
        ...
        post :create, {:portfolio => { "project_name" => "invalid value" }}, valid_session
        assigns(:portfolio).should be_a_new(Portfolio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested portfolio" do
        ...
        Portfolio.any_instance.should_receive(:update_attributes).with({ "project_name" => "MyString" })
        put :update, {:id => portfolio.to_param, :portfolio => { "project_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the portfolio as @portfolio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Portfolio.any_instance.stub(:save).and_return(false)
        put :update, {:id => portfolio.to_param, :portfolio => { "project_name" => "invalid value" }}, valid_session
        assigns(:portfolio).should eq(portfolio)
      end
