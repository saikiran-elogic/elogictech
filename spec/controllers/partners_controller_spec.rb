...
describe PartnersController do
  ...
  let(:valid_attributes) { { "partner_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved partner as @partner" do
        ...
        post :create, {:partner => { "partner_name" => "invalid value" }}, valid_session
        assigns(:partner).should be_a_new(Partner)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested partner" do
        ...
        Partner.any_instance.should_receive(:update_attributes).with({ "partner_name" => "MyString" })
        put :update, {:id => partner.to_param, :partner => { "partner_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the partner as @partner" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Partner.any_instance.stub(:save).and_return(false)
        put :update, {:id => partner.to_param, :partner => { "partner_name" => "invalid value" }}, valid_session
        assigns(:partner).should eq(partner)
      end
